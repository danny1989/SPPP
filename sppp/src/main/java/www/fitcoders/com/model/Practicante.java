...
public class Practicante implements Serializable {
    ...
    @Column(name = "apliacion")
    private Boolean apliacion;
    ...
    public Boolean getApliacion() {
        return apliacion;
    }

    public void setApliacion(Boolean apliacion) {
        this.apliacion = apliacion;
    }
    ...
    public Docente getIdAsesor() {
        return idAsesor;
    }

    public void setIdAsesor(Docente idAsesor) {
